        ...
        let result = match task.task_type {
            TaskType::GenerateTag => {
                ...
                let release_notes = self
                    .generate_release_notes(&next_version, commits, context)
                    .await?;
                ...
                data.insert(
                    ...
                    serde_json::Value::String(release_notes.clone()),
                );
            ...
            TaskType::GenerateDocumentation => {
                ...
                let changelog = self
                    .generate_changelog(from_version, to_version, &task.input, context)
                    .await?;
...
mod tests {
    ...
    fn test_generate_next_version() {
        ...
        assert_eq!(
            agent
                .generate_next_version("1.2.3", VersionBump::Major)
                .unwrap(),
            "2.0.0"
        );
        ...
        assert_eq!(
            agent
                .generate_next_version("1.2.3", VersionBump::Minor)
                .unwrap(),
            "1.3.0"
        );
        ...
        assert_eq!(
            agent
                .generate_next_version("1.2.3", VersionBump::Patch)
                .unwrap(),
            "1.2.4"
        );
        ...
        assert_eq!(
            agent
                .generate_next_version("1.2.3", VersionBump::Prerelease("beta".to_string()))
                .unwrap(),
            "1.2.3-beta.1"
        );
    }
