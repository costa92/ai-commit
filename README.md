...
- **🔥 AI 增强代码审查**：结合静态分析 + AI 智能分析，提供质量评分、安全检测、性能优化建议
...
| **🤖 AI 审查相关参数**        |                                              |             |
| --ai-review                  | 启用 AI 代码审查（结合静态分析）             | false       |
| --ai-review-type TYPE        | AI 审查类型 (general/security/performance/architecture) | general |
| --ai-review-detail LEVEL     | AI 审查详细程度 (brief/detailed/comprehensive) | detailed |
| --ai-language-specific       | 启用语言特定的 AI 审查规则                   | true        |
| --ai-include-static          | 包含静态分析结果在 AI 审查中                 | true        |
| --ai-review-lang LANG        | AI 审查的输出语言 (zh/en)                    | zh          |
| **🌳 Git Worktree 相关参数** |                                              |             |
...
```sh
# 启用 AI 代码审查（结合静态分析 + AI 智能分析）
$ ai-commit --ai-review

# 指定 AI 审查类型
$ ai-commit --ai-review --ai-review-type security    # 安全审查
$ ai-commit --ai-review --ai-review-type performance # 性能审查
$ ai-commit --ai-review --ai-review-type architecture # 架构审查
$ ai-commit --ai-review --ai-review-type general     # 通用审查（默认）

# 指定 AI 审查详细程度
$ ai-commit --ai-review --ai-review-detail brief         # 简要分析
$ ai-commit --ai-review --ai-review-detail detailed      # 详细分析（默认）
$ ai-commit --ai-review --ai-review-detail comprehensive # 全面分析

# AI 审查高级选项
$ ai-commit --ai-review --ai-language-specific=true --ai-include-static=true --ai-review-lang=zh
...
**🔥 AI 审查功能特性：**
- **🧠 智能代码质量评分**：安全性、性能、可维护性多维度评分（1-10分）
- **🎯 语言特定规则**：针对 Rust、Go、JavaScript、TypeScript 的专业审查规则
- **🔒 安全漏洞检测**：识别潜在的安全风险和最佳实践违规
- **⚡ 性能优化建议**：提供具体的性能改进建议和代码优化方案
- **📚 学习资源推荐**：为发现的问题提供相关学习资料和文档链接
- **🤝 静态分析集成**：将静态分析工具结果融入 AI 审查，提供更全面的代码质量评估
